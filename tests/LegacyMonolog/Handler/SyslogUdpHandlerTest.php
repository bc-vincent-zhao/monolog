...
namespace LegacyMonolog\Handler;

use LegacyMonolog\TestCase;
...
class SyslogUdpHandlerTest extends TestCase
{
    ...
    public function testWeSplitIntoLines()
    {
        ...
        $handler->setFormatter(new \LegacyMonolog\Formatter\ChromePHPFormatter());
    ...
    public function testRfc()
    {
        ...
        $handler = $this->getMockBuilder('\Monolog\Handler\SyslogUdpHandler')
            ->setConstructorArgs(array("127.0.0.1", 514, "authpriv", null, null, "php", \LegacyMonolog\Handler\SyslogUdpHandler::RFC3164))
            ->setMethods(array('getDateTime'))
            ->getMock();
    ...
    {
        return array('message' => $msg, 'level' => \LegacyMonolog\Logger::WARNING, 'context' => null, 'extra' => array(), 'channel' => 'lol');
    }
}